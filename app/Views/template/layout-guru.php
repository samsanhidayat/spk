          ...
          <li class="nav-item dropstart">
            ...
            <div class="dropdown-menu mt-2 pt-0" aria-labelledby="navbarDropdown">
              <div class="d-flex p-3 border-bottom mb-2">
                ...
                <div class="d-block">
                  <p class="fw-bold m-0 lh-1"><?= $user['nama_guru']; ?></p>
                  <small><?= $user['level']; ?></small>
                </div>
              </div>
              <a class="dropdown-item" href="<?= base_url('guru/home/profile/' . $user['id_guru']); ?>">
    ...
    <div class="slider" id="sliders">
      <div class="slider-head">
        <div class="d-block pt-4 pb-3 px-3">
          ...
          <p class="fw-bold mb-0 lh-1 text-white"><?= $user['nama_guru']; ?></p>
          <small class="text-white"><?= $user['level']; ?></small>
        </div>
      </div>
      <div class="slider-body px-1">
        <nav class="nav flex-column">
          <ul>
            <li>
              <a class="nav-link px-3 active" href="<?= base_url('guru/home'); ?>">
                <i class="fa fa-home fa-lg box-icon" aria-hidden="true"></i>Home
              </a>
            </li>
            <hr class="soft my-1 bg-white" />
            <li>
              <a class="nav-link px-3" href="<?= base_url('guru/home/perhitungan'); ?>">
